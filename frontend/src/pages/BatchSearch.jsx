                  ...
                  {!farmerData ? (
                    ...
                    {(farmerData.processingCapabilities || farmerData.processing_capabilities || []).length > 0 && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(farmerData.processingCapabilities || farmerData.processing_capabilities || []).map((capability, idx) => (
                    ...
                    <div>
                      ...
                      {(farmerData.farmPhotosUrls || farmerData.farm_photos_urls || []).length > 0 && (
                        <div>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                            {(farmerData.farmPhotosUrls || farmerData.farm_photos_urls || []).map((photo, idx) => (
                              <img
                                key={idx}
                                src={photo}
                                alt={`Farm ${idx + 1}`}
