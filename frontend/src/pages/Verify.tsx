...
const BatchSearch = () => {
  ...
  const handleSearchWithId = async (batchId: string) => {
    if (!batchId.trim()) {
    ...
    try {
      ...
      // Get farmer profile and details
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-green-600">
                        {batchData.available_quantity_kg ?? batchData.quantity_kg} kg
                      </p>
                    </div>
                    {batchData.sold_quantity_kg > 0 && (
                      <div>
                        <p className="text-sm text-muted-foreground">Sold</p>
                        <p className="font-medium text-blue-600">
                          {batchData.sold_quantity_kg} kg
                        </p>
                      </div>
                    )}
                    <div>
