...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-hero flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-lg bg-white dark:bg-gray-900">
        ...
        <CardContent>
          <Tabs defaultValue="login" className="w-full" onValueChange={(value) => console.log(value)}>
            <TabsList className="grid w-full grid-cols-2 mb-6 bg-gray-100 dark:bg-gray-800 p-1 rounded-lg">
              <TabsTrigger 
                value="login" 
                className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md transition-all duration-300 rounded-md font-medium"
              >
                Login
              </TabsTrigger>
              <TabsTrigger 
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent position="popper" className="bg-white dark:bg-gray-900 z-50 w-full">
