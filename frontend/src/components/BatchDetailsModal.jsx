...
// BatchDetailsModalProps removed

const BatchDetailsModal = ({ batch, open, onOpenChange, hideContactInfo = false }) => {
                  ...
                  <div className="space-y-3">
                    ...
                    {farmerDetails.certifications && Array.isArray(farmerDetails.certifications) && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1 mt-1">
                          {farmerDetails.certifications.map((cert, index) => (
                    ...
                    {farmerDetails.farming_practices && Array.isArray(farmerDetails.farming_practices) && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1 mt-1">
                          {farmerDetails.farming_practices.map((practice, index) => (
