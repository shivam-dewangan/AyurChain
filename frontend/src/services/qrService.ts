...
export class QRCodeService {
  ...
  generateBatchVerificationURL(batchNumber: string): string {
  ...
  async generateQRCodeSVG(batchNumber: string): Promise<string> {
    try {
      const verificationURL = this.generateBatchVerificationURL(batchNumber);
  ...
  downloadQRCode(batchNumber: string, qrCodeDataURL: string): void {
  ...
  // Print QR code
  printQRCode(batchNumber: string, qrCodeDataURL: string): void {
